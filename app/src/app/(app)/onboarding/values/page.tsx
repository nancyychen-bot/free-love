...
const DEFAULT_RANKED = ['family', 'freedom', 'growth', 'honesty', 'adventure'];
const DEFAULT_UNRANKED = ['faith', 'security', 'creativity', 'justice', 'intellectual life'];
    ...
    <div className="screen" style={{ padding: '0 0 60px 0' }}>
      ...
      <div style={{ padding: '40px 24px 0' }}>
        ...
        <p style={{
          ...
          Five values, ranked one through five. They cannot be tied. The order is what we match on.
        </p>
